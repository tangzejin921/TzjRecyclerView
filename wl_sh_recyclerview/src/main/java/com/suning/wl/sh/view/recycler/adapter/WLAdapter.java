package com.suning.wl.sh.view.recycler.adapter;
...
import com.suning.wl.sh.view.recycler.IViewType;
import com.suning.wl.sh.NoDoubleOnClickListener;
        ...
        if (manager instanceof GridLayoutManager) {
            ...
            gridManager.setSpanSizeLookup(new WLSpanSizeLookup() {
                ...
                public int getSpanSize(int position) {
                    ...
                    if (item instanceof com.suning.wl.sh.view.recycler.layoutmanager.GridLayoutManager.SpanSize) {
                        return ((com.suning.wl.sh.view.recycler.layoutmanager.GridLayoutManager.SpanSize) item).getSpanSize();
                    } else {
                        return 1;
                    }
                }
