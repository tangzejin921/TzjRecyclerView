package com.suning.wl.sh.view.recycler.holder;
 ...
 *
 */
public class WLViewHolder<D> extends BaseViewHolder {

    protected ViewDataBinding binding;

    protected View.OnClickListener listener;

    public WLViewHolder(View itemView) {
        super(itemView);
    }
     ...
     * 构造方法里取不到 WLAdapter
     */
    public void onCreateView(Context ctx, WLAdapter adapter, View itemView) {
        try {
     ...
     *
     */
    public void onBind(WLAdapter adapter, D item, int position) {
        if (binding != null) {
     ...
     * 绑定 OnclickListener
     */
    public WLViewHolder<D> setOnClickListener(View view, int position) {
    ...
    protected int onBrId(String name) {
        try {
            ...
            return com.suning.wl.sh.view.BR._all;
        }
    }
